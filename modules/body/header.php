        ...
        <section class="headerClass">
            ...
            <div class="listeIcone">
                <nav class="btn-group">
                    ...
                    <div  class="col-xs-3" onclick="menu();"  style="color:white"<?php if ($page=="notifications") {print 'class="selected"';} ?>><a class=" btn btn-info" ><i class="fa-solid fa-bell fa-xl"></i> <?php $ok=getNbNotif($account); print($ok); ?></a></div>

        ...
        <section class="content">
            ...
            <nav>
                <ul>
                    ...
                    <li <?php if ($page=="notifications") {print 'class="selected"';} ?>><a href=""><i class="fa-solid fa-bell"></i> Notifications</a></li>
                    <li <?php if ($page=="account") {print 'class="selected"';} ?>><a href="account.php"><i class="fa-solid fa-user"></i> Mon compte (<?php print $account; ?>)</a></li>
                </ul>
            </nav>
        </section>
